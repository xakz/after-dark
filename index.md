...
Head to [Hack Cabin](https://hackcabin.com) for a **production example** running on AWS and to learn more about [the Hack Cabin architecture](https://hackcabin.com/post/initial-commit/) and how to recreate it.
